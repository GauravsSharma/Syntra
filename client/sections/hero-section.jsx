    ...
    return (
        <>
            ...
            <motion.section className="flex flex-col items-center">
                ...
                >
                    <span className="italic"> Human Friendly</span>  Support, Powered <span className="italic"> By  AI</span>
                </motion.h1>
                <motion.p className="text-center text-gray-100 text-base/7 max-w-md mt-6"
                    ...
                    transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
                >
                    Embed AI powered chatbot for customer support by perfoming simple steps -- all in one place.
                </motion.p>

                <motion.div className="flex flex-col md:flex-row max-md:w-full items-center gap-4 md:gap-3 my-6"
                    initial={{ y: 50, opacity: 0 }}
                    whileInView={{ y: 0, opacity: 1 }}
                    viewport={{ once: true }}
