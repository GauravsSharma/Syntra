...
export default function CallToAction() {
    return (
        ...
        >
            ...
            <motion.p className="mt-4 text-sm/7 max-w-xl"
                initial={{ y: 80, opacity: 0 }}
                whileInView={{ y: 0, opacity: 1 }}
                viewport={{ once: true }}
                transition={{ type: "spring", stiffness: 200, damping: 70, mass: 1 }}
            >
              Turn your ideas into a powerful AI chatbot in minutes. Build, customize, and deploy effortlessly — get started for free, no credit card required. </motion.p>
